...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "max-h-[320px] scroll-py-1 overflow-x-hidden overflow-y-auto p-1",
        className
      )}
      {...props}
    />
